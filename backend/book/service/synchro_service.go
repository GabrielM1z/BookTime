...
// func (ss *SynchroService) fetchGoogleBook(isbn string) (model.BookInfo, error) {
...
// func (ss *SynchroService) fetchAmazonBook(isbn string) (model.BookInfo, error) {
...
func (ss *SynchroService) Synchro(client_actions []model.Action) ([]model.Action, error) {
	...
	client_actions_to_exec := mixed_actions

	return client_actions_to_exec, nil
