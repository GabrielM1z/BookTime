...
func (repo *BookAuthorRepository) SelectBookAuthor(idAuthor uuid.UUID, idBook string) (model.BookAuthor, error) {
...
func (repo *BookAuthorRepository) DeleteBookAuthor(idAuthor uuid.UUID, idBook string) bool {
