...
export const keycloakClientSecret = process.env.KEYCLOAK_CLIENT_SECRET || "szM12JEwNGOLLUuLnIRfYEdEqcH1LDFq";
export const keycloakClientId = process.env.KEYCLOAK_CLIENT_ID || "gateway-client";
