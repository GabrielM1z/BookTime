...
// Sous ecran de la bibliotheque, affichage par AUTEUR
export default function pageAuteur() {
	...
	const etageres = [
		{ title: 'Auteur 1', books: books},
		{ title: 'Auteur 2', books: books},
		{ title: 'Auteur 3', books: books},
		{ title: 'Auteur 4', books: books},
		{ title: 'Auteur 5', books: books},
		{ title: 'Auteur 6', books: books},
		{ title: 'Auteur 7', books: books},
		{ title: 'Auteur 8', books: books},
		{ title: 'Auteur 9', books: books},
		{ title: 'Auteur 10', books: books},
	]
